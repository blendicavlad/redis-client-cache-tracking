...
def test_special_chars_multiple_clients_should_get_notified_before_and_after_query():
    ...
    r1.execute_command("CCT.REGISTER " + client_1)
    r1.execute_command(
        "CCT.FT.SEARCH " + cct_prepare.TEST_INDEX_NAME + " @User\\.Address\\.ID:{20\\-00}")
...
def test_special_chars_overwritten_value_not_matching_query_should_be_removed_from_q2_and_remain_on_q1():
    ...
    r1.execute_command("CCT.REGISTER " + client_1)
    r1.execute_command(
        "CCT.FT.SEARCH " + cct_prepare.TEST_INDEX_NAME + " @User\\.PASSPORT:{2JRUX4\\-G5}")
    r1.execute_command(
        "CCT.FT.SEARCH " + cct_prepare.TEST_INDEX_NAME + " @User\\.Address\\.ID:{" + addr_id + "}")
    ...
    r1.execute_command(
        "CCT.FT.SEARCH " + cct_prepare.TEST_INDEX_NAME + " @User\\.Address\\.ID:{" + new_addr_id + "}")
